...
const Campaingn = () => {
    ...
    useEffect(() => {
        ...
        var month = currentDate.getMonth().length < 0 ? 0+currentDate.getMonth()+1 : currentDate.getMonth() +1 // Month is zero-based, so we add 1
    ...
    async function fetchData() {
        try {
            ...
            // if (adserverdata.message != "Network Error" || dbm.message != "Network Error") {
    ...
    // console.log(adserverdata?.data,"9090909")
    return (
        <>
                ...
                <div className="">
                    <div className="wrap">
                        <div className="date d-flex justify-content-end gap-2  ">
                            ...
                            <button className="ms-2 common_button" onClick={() => {
                                fetchData()
                                setLoader(true)
                            }}>
                                Report
